...
function upgrade_module_3_1_5($module)
{
    ...
    if (!$db->execute('TRUNCATE TABLE `'.$table.'`')) {
        PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::ERROR: Failed to truncate egoi_customers");
        return false;
    }
    PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::LOG: Truncated egoi_customers");
    ...
    if (!$hasPayloadHash) {
        ...
        if (!$db->execute($q)) {
            PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::ERROR: Failed to add payload_hash column");
            $return = false;
        } else {
            PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::LOG: Added payload_hash column");
        }
    } else {
        PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::LOG: payload_hash already exists");
    }
    ...
    if (!$hasUniqueIdCart) {
        ...
        if (!$db->execute($q)) {
            PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::ERROR: Failed to add UNIQUE index uniq_cart(id_cart)");
            $return = false;
        } else {
            PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::LOG: Added UNIQUE index uniq_cart(id_cart)");
        }
    } else {
        PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::LOG: uniq_cart index already exists");
    }
    ...
    if (!$hasSyncStock) {
        ...
        if (!$db->execute($q)) {
            PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::ERROR: Failed to add sync_stock column");
            $return = false;
        } else {
            PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::LOG: Added sync_stock column");
        }
    } else {
        PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::LOG: sync_stock already exists");
    }
    ...
    if (!$hasSyncVariations) {
        ...
        if (!$db->execute($q)) {
            PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::ERROR: Failed to add sync_variations column");
            $return = false;
        } else {
            PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::LOG: Added sync_variations column");
        }
    } else {
        PrestaShopLogger::addLog("[EGOI-PS8]::" . __FUNCTION__ . "::LOG: sync_variations already exists");
    }
